...
statusbar.states.add
	...
	rezeptsuche:
		...
		style:
				...
				textIndent: "#{hintergrund.width*0.23}px"
	zufallsrezept:
		html: menuename[3] #HIER ZUFALLSREZEPTNAME
		style:
				color:      "#000"
				lineHeight: "#{hintergrund.height*0.12}px"
				fontSize:   "#{hintergrund.height*0.05}px"
...
textfield.on Events.Click, ->
	inputField1 = document.getElementById('input1')
	inputField1.ignoreEvents = false
	inputField1.focus()

textfield.states.add
	hidden:  opacity: 0, x: -menue.width
	halfhidden: opacity: 0.5
	visible: opacity: 1, x: (hintergrund.width-hintergrund.width*0.82)/2
#------------------------------------------------------------
...
createMenuePunkte = (rows) ->
	...
	menuepunkt0.onClick -> #Kategorien
		logo_mit_pfeil.states.switchInstant("visible")
		logo_ohne_pfeil.states.switchInstant("hidden")
		menue.states.switch("hidden")
		suche.states.switchInstant("hidden")
		statusbar.states.switchInstant("kategorien")

	menuepunkt1.onClick -> #Meine Rezepte
		logo_mit_pfeil.states.switchInstant("visible")
		logo_ohne_pfeil.states.switchInstant("hidden")
		menue.states.switch("hidden")
		suche.states.switchInstant("hidden")
		statusbar.states.switchInstant("meineRezepte")

	menuepunkt2.onClick -> #Rezeptsuche
		logo_mit_pfeil.states.switchInstant("visible")
		logo_ohne_pfeil.states.switchInstant("hidden")
		menue.states.switch("hidden")
		suche.states.switchInstant("visible")
		statusbar.states.switchInstant("rezeptsuche")

	menuepunkt3.onClick -> #Zufallsrezept
		logo_mit_pfeil.states.switchInstant("visible")
		logo_ohne_pfeil.states.switchInstant("hidden")
		menue.states.switch("hidden")
		suche.states.switchInstant("hidden")
		statusbar.states.switchInstant("zufallsrezept")
#------------------------------------------------------------
